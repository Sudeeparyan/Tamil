...
function SetNullParams(){ 
    document.querySelector("#temp-c-bottom").innerHTML="NULL";
    document.querySelector("#farenheit").innerHTML="NULL";
    document.querySelector("#humidity").innerHTML="NULL";
    document.querySelector("#precipitation").innerHTML="NULL";
    ...
    for(let i=0;i<6;i++){
      document.querySelector(`#hourly-time-${i + 1}`).innerHTML = "NULL"; 
      document.querySelector(`#icon-weather-${i + 1}`).src = "../assets/weather-icons/sad.png"; 
      document.querySelector(`#temperature-${i + 1}`).innerHTML = "NULL";
    }
}
